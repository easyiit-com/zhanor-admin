...
def insert_default_data(session):
    ...
    default_data = [
        ...
        AdminRule(id=16, type='menu', pid=15, addon=0, name='admin.attachment.image', url_path='/admin/attachment/image', title='Attachment Image', description='None', icon='ti ti-file-image-o', menutype='addtabs', extend='None', createtime=datetime(2024, 1, 22, 14, 32), updatetime=datetime(2024, 1, 22, 14, 32), weigh=9, status='normal'),
        AdminRule(id=17, type='action', pid=16, addon=0, name='admin.attachment.image.add', url_path='/admin/attachment/image/add', title='Add', description='None', icon='None', menutype='addtabs', extend='None', createtime=datetime(2024, 1, 22, 14, 32), updatetime=datetime(2024, 1, 22, 14, 32), weigh=35, status='normal'),
        AdminRule(id=18, type='action', pid=16, addon=0, name='admin.attachment.image.edit', url_path='/admin/attachment/image/edit/{id}', title='Edit', description='None', icon='None', menutype='addtabs', extend='None', createtime=datetime(2024, 1, 22, 14, 32), updatetime=datetime(2024, 1, 22, 14, 32), weigh=36, status='normal'),
        AdminRule(id=19, type='action', pid=16, addon=0, name='admin.attachment.image.save', url_path='/admin/attachment/image/save', title='Save', description='None', icon='None', menutype='addtabs', extend='None', createtime=datetime(2024, 1, 23, 14, 32), updatetime=datetime(2024, 1, 23, 14, 32), weigh=37, status='normal'),
        AdminRule(id=20, type='action', pid=16, addon=0, name='admin.attachment.image.delete', url_path='/admin/attachment/image/delete', title='Delete', description='None', icon='None', menutype='addtabs', extend='None', createtime=datetime(2024, 1, 22, 14, 32), updatetime=datetime(2024, 1, 22, 14, 32), weigh=37, status='normal'),
