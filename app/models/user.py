...
class User(UserMixin,Base):
    ...
    level = db.Column(db.SmallInteger, nullable=False,comment='Level') 
    gender = db.Column(db.Enum('female', 'male'), nullable=False,comment='Gender') 
    ...
    successions = db.Column(db.Integer, nullable=False,comment='Consecutive Login Days') 
    maxsuccessions = db.Column(db.Integer, nullable=False,comment='Maximum Consecutive Login Days') 
    ...
    loginfailure = db.Column(db.SmallInteger, nullable=False,comment='Failed Login Attempts') 
